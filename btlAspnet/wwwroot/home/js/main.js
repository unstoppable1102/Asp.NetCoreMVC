...
(function ($) {
    ...
    -----------------------------*/
    var minPrice = window.minPrice || 40; // Default to 0 if not defined
    var maxPrice = window.maxPrice || 300;
    ...
    $('#filter-btn').on('click', function () {
        ...
        filterForm.submit(); // Submit the form to send the values to the backend
    });
